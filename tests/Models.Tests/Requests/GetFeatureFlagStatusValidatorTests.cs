// <copyright file="GetFeatureFlagStatusValidatorTests.cs" company="Defra">
...
{
    private readonly GetFeatureFlagStatusValidator validator = new();
    ...
    [Fact]
    public void Should_Have_Error_When_FlagName_Is_Empty()
    {
        var model = CreateValidRequest();

        model.FlagName = string.Empty;
    ...
    [Fact]
    public void Should_Have_Error_When_FlagName_Is_WhiteSpace()
    {
        var model = CreateValidRequest();
    ...
    [Fact]
    public void Should_Have_Error_When_FlagName_Exceeds_100_Characters()
    {
        var model = CreateValidRequest();

        model.FlagName = new string('a', 101);
    ...
    private static GetFeatureFlagStatus CreateValidRequest() =>
        new GetFeatureFlagStatus()
        {
            EnvironmentName = "prod", ProductName = "LIS", GroupName = "payments", FlagName = "flag-1",
        };
}
